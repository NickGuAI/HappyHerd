...
executable owner; release and rehearsal commands may reject feature branches or
dirty trees by design.
...
| Reproducible artifacts | `docs/build-provenance.md` | `scripts/assert-origin-main.sh`, `scripts/build-release-artifacts.sh`, `scripts/verify-reproducible-build.sh` |
...
| Troubleshooting and diagnostics | CLI README files, `docs/runtime-isolation.md`, `docs/release-rollback.md` | `happyherd doctor`, `happy doctor`, `scripts/health-happyherd-agent.sh` |
| Runtime deployment boundaries | `docs/runtime-isolation.md` | `scripts/validate-runtime-isolation.sh`, `scripts/prepare-runtime.sh`, `scripts/run-container.sh` |
| Host release and rollback | `docs/release-rollback.md` | `scripts/install-host-release.sh`, `scripts/activate-release.sh`, `scripts/rollback-release.sh` |
...
HappyHerd guidance owns this distribution's lineage, branch, patch, release,

...
const directory=resolve(repoRoot,'docs/acceptance/issue-287/panels/production');
...
try{
 for(const theme of ['light','dark'])for(const viewport of [{width:1440,height:900},{width:390,height:844}]){
  const context=await browser.newContext({viewport,colorScheme:theme,locale:'en-US',hasTouch:viewport.width<500,isMobile:viewport.width<500});

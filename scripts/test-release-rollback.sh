...
repo='ghcr.io/example/happyherd'
...
const repo = 'ghcr.io/example/happyherd';
...
write_runtime_env() {
    local image="$1"
    printf '%s\n' \
        'HAPPYHERD_DOMAIN=happyherd.example.com' \
        'HAPPYHERD_PUBLIC_URL=https://happyherd.example.com' \

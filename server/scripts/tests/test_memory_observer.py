...
class MemoryObserverTest(unittest.TestCase):
    ...
    def test_prompt_bounds_both_sources_and_l1_only(self) -> None:
        ...
        self.assertIn("/home/ec2-user/.claude/projects/**/*.jsonl", prompt)
        self.assertIn("/home/ec2-user/.codex/sessions/**/*.jsonl", prompt)
    ...
    def test_invokes_one_ephemeral_codex_agent_for_the_window(
        ...
        self.assertEqual(kwargs["env"]["HAPPY_HOME_DIR"], "/home/ec2-user/.happyherd")

# HappyHerd User Deep Dive — Full Analysis
...
HappyHerd has 502 unique external contributors across 793 issues+PRs. The userbase is **truly global** — roughly 35% East Asian (China, Japan, Korea, HK), 40% Western (US, Europe, AU), 15% South/Southeast Asian, 10% other. Activity peaked in mid-February 2026 (43 new users/week) and has stabilized at ~27 new users/week.
...
- HappyHerd activity: 1 issue (Nov 2025). Early user.
...
- HappyHerd activity: 1 issue (Jan 2026).
...
- HappyHerd activity: 4 issue comments. Lurker-engager.
...
- HappyHerd activity: 2 contributions (Jan 2026), including a PR.
...
- HappyHerd activity: 5 PRs (3 merged, Dec 2025). Android fixes. Also 10 comments.
...
- HappyHerd activity: 1 merged PR (Jan 2026) — swipe to archive/delete sessions.
...
- HappyHerd activity: 1 PR (Feb 2026) — removing credential logging.
...
- Created **happyherd-devbox** (30 stars) — dev environment for HappyHerd
- HappyHerd activity: 1 PR + 10 comments.
...
- HappyHerd activity: 1 issue (Nov 2025). Very early.
...
- HappyHerd activity: 4 contributions spanning Sep 2025-Feb 2026. Very early, very persistent.
...
- HappyHerd activity: 3 PRs (Sep-Oct 2025). VERY early. First external feature contributor.
...
- HappyHerd activity: 5 contributions (Feb 2026). PRs: camera dismiss, Ink rendering, tmux detach.
...
- HappyHerd activity: 6 issues (Feb 2026). Thoughtful UX-focused bug reports.
...
- HappyHerd activity: 1 PR (Feb 2026) — PTY proxy stdin corruption fix.
...
- HappyHerd activity: 7 contributions (Feb 2026). UX bug reports.

**brtkwr (Bharat)** — Bristol, UK — 52 followers
- Security engineer at **Two Inc** (B2B payments fintech)
- HappyHerd activity: 7 security issues in ONE DAY (Feb 19). Full security audit: QR auth expiry, wildcard CORS, debug logs, Docker root, RevenueCat bypass.
...
- HappyHerd activity: 5 contributions spanning Nov 2025-Mar 2026. 13 comments.
...
- HappyHerd activity: 6 contributions (Mar 2026). Server status, web errors, UX.
...
- **Built the entire HappyHerd self-hosted ecosystem:** happyherd-stacks, happyherd-server-light, happyherd-cli, slopus.github.io (docs)
...
- Also built own **hapi** fork and **happyherd-cli** fork
...
These 12 people were using HappyHerd before it had any real traction:
...
4. **The Ecosystem Builder** (leeroybrun, chris-yyau, EricSeastrand) — Builds tools, docs, and infrastructure around HappyHerd
...
1. **You have genuine industry credibility.** Instagram's first engineer, OpenAI, Meta EMs, CMU professors, Apollo/Meteor core engineers, ReactiveUI creators, and Google ML researchers all use HappyHerd. This is not a toy project.

2. **Steve Korshakov (ex3ndr) is your #1 community asset.** 90 comments, 11 PRs (via bot), plugin architecture work. He's basically volunteering as a co-maintainer. The llama-coder creator (2K stars) clearly believes in HappyHerd.
...
7. **tiann (weishu) is both an ally and a competitor.** His hapi project (3.4K stars) does the same thing. His early Android fixes for HappyHerd were likely cross-pollination. Worth watching.

8. **The "burst contributor" pattern** (12 PRs in 1 day, 18 issues in 1 day) suggests people discover HappyHerd and immediately deep-dive. First impressions matter enormously.
...
10. **The product has genuine "vibe coding" PMF.** The fact that Claude Code, Codex, Gemini, Kimi, and OpenCode integrations are all being contributed by users suggests HappyHerd is becoming the universal mobile frontend for AI coding agents.

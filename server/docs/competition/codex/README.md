...
Reviewed on 2026-03-20 from `../happyherd-adjacent/research/codex` at commit
...
- If HappyHerd wants a server-side session protocol, Codex is the best reference.
- If HappyHerd wants a UI/session transcript shape, OpenCode still feels stronger.

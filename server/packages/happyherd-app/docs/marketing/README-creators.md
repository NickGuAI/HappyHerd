# HappyHerd Coder Content Creator Brief

## Key Features

HappyHerd Coder is an open-source mobile app that lets developers control AI coding agents (Claude Code, Codex, Gemini-CLI) from their phone.
...
- On HappyHerd Coder, I can manage Claude Code from my phone without paying $600/year
- On HappyHerd Coder, I never miss when Claude gets stuck on a permission prompt
- HappyHerd Coder runs on my own computer, not expensive cloud servers
- On HappyHerd Coder, I can check on long-running tasks without returning to my desk
- HappyHerd Coder is open source - I can audit, modify, or self-host everything
- On HappyHerd Coder, I can run multiple agents in parallel and switch between them instantly
- HappyHerd Coder keeps my code on my machines with end-to-end encryption
- On HappyHerd Coder, I can keep coding while commuting, eating, or away from my desk

## Example Hooks

- "I saved $600/year by switching from [competitor] to the open-source HappyHerd Coder"

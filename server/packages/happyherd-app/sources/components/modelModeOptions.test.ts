...
describe('modelModeOptions', () => {
    ...
    it('filters only post-version hardcoded modes for an old HappyHerd CLI', () => {
        const modes = getClaudePermissionModes(translate);
    ...
    it('renders all native HappyHerd permission codes and semantic kinds without flavor fallbacks', () => {
    ...
    it('puts Astra first in the HappyHerd session picker while retaining model capabilities and selection', () => {
        const metadata = {
            ...rigMetadataFixture,

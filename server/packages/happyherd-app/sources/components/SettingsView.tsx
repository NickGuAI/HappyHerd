...
export const SettingsView = React.memo(function SettingsView({
    ...
    const [disconnectingGitHub, handleDisconnectGitHub] = useHappyHerdAction(async () => {
    ...
    const [connectingAnthropic, connectAnthropic] = useHappyHerdAction(async () => {
        router.push('/settings/connect/claude');
    });

    // Anthropic disconnection
    const [disconnectingAnthropic, handleDisconnectAnthropic] = useHappyHerdAction(async () => {
        const confirmed = await Modal.confirm(
    ...
    return (
        ...
        >
            ...
            <ItemGroup title={t('settings.features')}>
                ...
                />
                <Item
                    title={t('settingsCredentials.settingsRow')}
                    subtitle={t('settingsCredentials.settingsRowSubtitle')}
                    icon={<Ionicons name="key-outline" size={29} color={theme.colors.textLink} />}
                    onPress={() => router.push('/settings/credentials' as any)}
                />
                <Item
                ...
                <Item
                    ...
                    icon={<Ionicons name="mic-outline" size={29} color={theme.colors.textLink} />}
            ...
            <ItemGroup title={t('settings.about')}>
                <Item
                    ...
                    icon={<Ionicons name="sparkles-outline" size={29} color={theme.colors.textLink} />}
                    onPress={() => {

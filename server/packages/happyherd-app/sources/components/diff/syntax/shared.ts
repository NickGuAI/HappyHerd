 ...
 */
const globals = globalThis as typeof globalThis & { __happyherdDiffSyntaxService?: SyntaxService };
export const diffSyntax = globals.__happyherdDiffSyntaxService ??= new SyntaxService(createSyntaxWorker());
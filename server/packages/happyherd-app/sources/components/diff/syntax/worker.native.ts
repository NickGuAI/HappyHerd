            ...
            return new Promise((resolve, reject) => {
                ...
                try {
                    if (!runtime) {
                        ...
                        runtime = createWorkletRuntime({ name: 'happyherd-diff-syntax' });
                    ...
                    scheduleOnRuntime(runtime, (jobId: number, serialized: string) => {
                        ...
                        const globals = globalThis as typeof globalThis & {
                            __happyherdDiffSyntax?: (input: SyntaxInput) => SyntaxResult;
                        };
                        try {
                            if (!globals.__happyherdDiffSyntax) globals.__happyherdDiffSyntax = createDiffSyntax();
                            const result = globals.__happyherdDiffSyntax!(JSON.parse(serialized));

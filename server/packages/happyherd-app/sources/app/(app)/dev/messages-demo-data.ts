...
const MARKDOWN_RENDERER_TEST_IMAGE = 'https://placehold.co/800x400/png?text=HappyHerd';
...
Inline code now renders as \`happyherd render\` without a background highlight.

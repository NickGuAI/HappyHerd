...
export default React.memo(function VoiceSettingsScreen() {
    ...
    const handleConfigureTranscriptionKey = React.useCallback(async () => {
        ...
        const value = await Modal.prompt(
            ...
            t("uiCopy.usedOnlyForVoiceDictationTranscriptionHappyHerdherdEncryptsItFor"),
            {
    ...
    return (
        <ItemList style={{ paddingTop: 0 }}>
            <ItemGroup
                ...
                footer={t("uiCopy.theKeyIsEncryptedForYourAccountHappyHerdherdOnlyDisplays")}
            >
                <Item

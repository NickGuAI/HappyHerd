...
export default function FriendsScreen() {
    ...
    const [acceptLoading, doAccept] = useHappyHerdAction(async () => {
    ...
    const [rejectLoading, doReject] = useHappyHerdAction(async () => {
        if (!credentials || !processingId) return;
    ...
    const [removeLoading, doRemove] = useHappyHerdAction(async () => {
        if (!credentials || !processingId) return;

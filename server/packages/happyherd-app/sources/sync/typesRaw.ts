...
import { stripLeadingTaskNotificationWrappers } from '@happyherd/wire';
...
const rawToolResultContentSchema = z.object({
    ...
    permissions: z.object({
        ...
        mode: z.enum(['default', 'acceptEdits', 'auto', 'dontAsk', 'bypassPermissions', 'plan', 'read-only', 'safe-yolo', 'yolo']).optional(),

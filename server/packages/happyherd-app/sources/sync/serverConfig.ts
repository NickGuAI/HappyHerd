...
export function getServerUrl(): string {
    return serverConfigStorage.getString(SERVER_KEY) ||
           (globalThis as any).__HAPPYHERD_CONFIG__?.serverUrl ||
           /* rename:preserve */ (globalThis as any).__HAPPY_CONFIG__?.serverUrl || /* /rename:preserve */
           process.env.EXPO_PUBLIC_HAPPYHERD_SERVER_URL ||
           /* rename:preserve */ process.env.EXPO_PUBLIC_HAPPY_SERVER_URL || /* /rename:preserve */
           DEFAULT_SERVER_URL;
}

...
import { removeOutboxRecordsInPlace } from './sendMessageLocalBatch';
...
function transport(state: ReturnType<typeof createReducer>) {
    ...
    const Harness = new Function('apiSocket', 'storage', 'normalizeRawMessage', 'log', 'removeOutboxRecordsInPlace', javascript)(
        apiSocket, storage, normalizeRawMessage, { log() {} }, removeOutboxRecordsInPlace,
    );
    ...
    Object.assign(sync, {
        ...
        settleStrictOutboxBatches() {},
        maybeStartBackgroundSendWatchdog() {},

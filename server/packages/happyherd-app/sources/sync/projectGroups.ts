...
// identity; HappyHerd CLI sessions use their machine and working directory.
...
export function buildSessionWorkspaceGroups(
    ...
    return [
        ...
        ...buildPathProjectGroups(happyherdPaths, toRow, isActive, 'happyherd')
            .map(project => ({ type: 'project' as const, source: 'happyherd' as const, project })),
    ];
}
 ...
 * path. HappyHerd-created worktree paths are nested under their main checkout,

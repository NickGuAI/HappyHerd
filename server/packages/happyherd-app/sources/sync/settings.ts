...
export const SettingsSchema = z.object({
    ...
    commanderProfilePictures: z.boolean().describe('Show machine-scoped Commander profile pictures in conversation lists'),
    userSafeguardEnabled: z.boolean().describe('Ask Claude and Codex to require one approval before complex artifact work in Human turns sent through the HappyHerd app'),
    ...
    voiceCustomAgentId: z.string().nullable().describe('Custom ElevenLabs agent ID (null to use HappyHerd default)'),
    voiceBypassToken: z.boolean().describe('Bypass HappyHerd server token and connect directly to ElevenLabs (requires custom agent ID)'),

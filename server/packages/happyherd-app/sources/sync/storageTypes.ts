...
export const MetadataSchema = z.object({
    ...
    happyHomeDir: z.string().optional(), // HappyHerd configuration directory
     ...
     * `parentSessionId` is the HappyHerd session this one was branched from.
    ...
    /** Fresh cross-provider session linked to its source HappyHerd session. */
...
export const MachineMetadataSchema = z.object({
    ...
    happyHomeDir: z.string(), // Directory for HappyHerd auth, settings, logs (usually .happyherd/ or .happyherd-dev/)
    ...
    cliAvailability: z.object({
        ...
        rig: z.boolean().optional(), // Rig runs its own HappyHerd-connected daemon
        detectedAt: z.number(),
    }).optional(),
    // Rig registers as its own machine instead of being launched by happyherd-cli.
    ...
    /** The restarted HappyHerd daemon exposes deleteFile through machine RPC. */

...
vi.mock('@/utils/errors', () => ({ HappyHerdError: class HappyHerdError extends Error {} }));
...
describe('SessionView side-chat integration', () => {
    ...
    it.each([
        ...
        { label: 'HappyHerd/Rig', flavor: 'rig', permissionMode: 'native-mode', clearsPermission: false, isRig: true },

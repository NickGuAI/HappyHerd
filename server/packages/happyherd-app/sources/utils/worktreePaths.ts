/** Relative path prefix where HappyHerd creates git worktrees inside a repo. */
export const WORKTREE_DIR = '.dev/worktree';

/** Absolute path marker used to detect HappyHerd-created worktree paths. */
export const WORKTREE_PATH_MARKER = `/${WORKTREE_DIR}/`;

/** Check if a path is inside a HappyHerd-created worktree. */

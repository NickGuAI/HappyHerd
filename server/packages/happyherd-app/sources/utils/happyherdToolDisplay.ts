/** Presentation only: real HappyHerd Agent names stay intact for call IDs and RPCs. */
type HappyHerdToolCategory = 'terminal' | 'edit' | 'read' | 'search' | 'web' | 'task';
type Presentation = { category: HappyHerdToolCategory; title: string };

export const happyherdToolDisplay: Record<string, Presentation> = {

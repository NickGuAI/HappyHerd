...
describe('sessionFileLinks', () => {
    const sessionRoot = '/Users/kirilldubovitskiy/projects/happyherd';

    it('parses absolute file refs with line numbers', () => {
        const result = parseSessionFileLink('/Users/kirilldubovitskiy/projects/happyherd/packages/happyherd-cli/src/codex/runCodex.ts:594', {
            sessionRoot,
        });

        expect(result).toEqual({
            path: '/Users/kirilldubovitskiy/projects/happyherd/packages/happyherd-cli/src/codex/runCodex.ts',
            absolutePath: '/Users/kirilldubovitskiy/projects/happyherd/packages/happyherd-cli/src/codex/runCodex.ts',
    ...
    describe('explicit Markdown targets', () => {
        it('resolves relative files and folder-looking targets against the session root', () => {
            expect(parseExplicitSessionFileLink('./packages/../docs', { sessionRoot })).toEqual({
                path: 'docs',
                absolutePath: '/Users/kirilldubovitskiy/projects/happyherd/docs',
                relativePath: 'docs',
                withinSessionRoot: true,
                line: null,
                column: null,
        ...
        it('decodes percent-encoded Markdown paths before resolving them', () => {
            expect(parseExplicitSessionFileLink('docs/My%20File-%E6%96%B9%E6%A1%88.md:17:2', { sessionRoot })).toEqual({
                ...
                absolutePath: '/Users/kirilldubovitskiy/projects/happyherd/docs/My File-方案.md',
        ...
        it('preserves malformed percent encodings instead of throwing', () => {
            expect(parseExplicitSessionFileLink('docs/bad%2name.md', { sessionRoot })).toMatchObject({
                ...
                absolutePath: '/Users/kirilldubovitskiy/projects/happyherd/docs/bad%2name.md',
            });
        });
        ...
        it('preserves line and column from the target or its label', () => {
            ...
            expect(parseExplicitSessionFileLink('README.md:18', { sessionRoot })).toMatchObject({
                absolutePath: '/Users/kirilldubovitskiy/projects/happyherd/README.md',
                line: 18,
                column: null,
            });
        ...
        it.each([
            ...
            expect(parseExplicitSessionFileLink(target, { sessionRoot })).toEqual({
                ...
                absolutePath: '/Users/kirilldubovitskiy/projects/happyherd/docs/My Report.md',
        ...
        it('keeps an invalid unterminated Markdown title as part of the path', () => {
            expect(parseExplicitSessionFileLink('docs/My Report.md "Project docs', { sessionRoot })).toMatchObject({
                ...
                absolutePath: '/Users/kirilldubovitskiy/projects/happyherd/docs/My Report.md "Project docs',
                line: null,
                column: null,
            });
        });
        ...
        it('removes raw query and fragment syntax before path decoding without losing coordinates', () => {
            expect(parseExplicitSessionFileLink('docs/README.md:44:2?view=source#install', { sessionRoot }))
                .toMatchObject({
                    path: 'docs/README.md',
                    absolutePath: '/Users/kirilldubovitskiy/projects/happyherd/docs/README.md',
                    line: 44,
                    column: 2,
                });
        });
        ...
        it('preserves percent-encoded query and fragment characters inside filenames', () => {
            expect(parseExplicitSessionFileLink('docs/README%23draft%3Fcopy.md', { sessionRoot }))
                .toMatchObject({
                    ...
                    absolutePath: '/Users/kirilldubovitskiy/projects/happyherd/docs/README#draft?copy.md',
                });
        });
        ...
        it('unwraps angle-bracket Markdown destinations before resolving paths with spaces', () => {
            expect(parseExplicitSessionFileLink('<docs/My File.md#install> "Project docs"', { sessionRoot }))
                .toMatchObject({
                    ...
                    absolutePath: '/Users/kirilldubovitskiy/projects/happyherd/docs/My File.md',
                });
        });
        ...
        it('preserves percent-encoded angle brackets that belong to a filename', () => {
            expect(parseExplicitSessionFileLink('docs/%3Cdraft%3E.md', { sessionRoot }))
                .toMatchObject({
                    path: 'docs/<draft>.md',
                    absolutePath: '/Users/kirilldubovitskiy/projects/happyherd/docs/<draft>.md',
                });
        });
        ...
        it('preserves a percent-encoded colon that belongs to a local filename', () => {
            expect(parseExplicitSessionFileLink('notes%3Afinal.md:17:2', { sessionRoot }))
                .toMatchObject({
                    path: 'notes:final.md',
                    absolutePath: '/Users/kirilldubovitskiy/projects/happyherd/notes:final.md',
                    line: 17,
                    column: 2,
                });
        });
        ...
        it('preserves decoded backslashes as filename data on POSIX machines', () => {
            expect(parseExplicitSessionFileLink('notes%5Cfinal.md', {
                sessionRoot: '/srv/projects/happyherd',
                platform: 'linux',
            })).toEqual({
                path: 'notes\\final.md',
                absolutePath: '/srv/projects/happyherd/notes\\final.md',
            ...
            expect(parseExplicitSessionFileLink('dir%5C..%5Cfile.md', {
                ...
                path: 'dir\\..\\file.md',
                absolutePath: '/srv/projects/happyherd/dir\\..\\file.md',
            });
            expect(parseExplicitSessionFileLink('C%3A/docs%5Cnotes.md', {
                ...
                path: 'C:/docs\\notes.md',
                absolutePath: '/srv/projects/happyherd/C:/docs\\notes.md',
            });
        });

        it('continues to treat decoded backslashes as separators on Windows machines', () => {
            expect(parseExplicitSessionFileLink('notes%5Cfinal.md', {
                sessionRoot: 'C:\\srv\\happyherd',
                platform: 'win32',
            })).toMatchObject({
                path: 'notes/final.md',
                absolutePath: 'C:/srv/happyherd/notes/final.md',
                relativePath: 'notes/final.md',
            });
        });
        ...
        it('preserves encoded leading query and fragment characters as filenames', () => {
            expect(parseExplicitSessionFileLink('%23details', { sessionRoot })).toMatchObject({
                path: '#details',
                absolutePath: '/Users/kirilldubovitskiy/projects/happyherd/#details',
            });
            expect(parseExplicitSessionFileLink('%3Ftab', { sessionRoot })).toMatchObject({
                path: '?tab',
                absolutePath: '/Users/kirilldubovitskiy/projects/happyherd/?tab',
            });
        });
    });
    ...
    it('does not turn slash-separated prose into file refs', () => {
        expect(splitSessionFileText(
            'Codex then starts/resumes turns with backend default model. I’m checking CLI docs/tests to confirm there is intentionally no happyherd codex model set or --model surface today.',
            sessionRoot,
        )).toEqual([
            {
                text: 'Codex then starts/resumes turns with backend default model. I’m checking CLI docs/tests to confirm there is intentionally no happyherd codex model set or --model surface today.',
                link: null,
            },
        ]);
    });
    ...
    it('resolves viewer input to an absolute path', () => {
        expect(resolveSessionFilePath('packages/happyherd-app/README.md', sessionRoot)).toEqual({
            path: 'packages/happyherd-app/README.md',
            absolutePath: '/Users/kirilldubovitskiy/projects/happyherd/packages/happyherd-app/README.md',
            relativePath: 'packages/happyherd-app/README.md',
            withinSessionRoot: true,
            line: null,
            column: null,
        });
    ...
    it('builds diffs only for shell-inert relative paths', () => {
        expect(buildSessionFileGitDiffCommand('packages/happyherd app/.mcp.json')).toBe(
            'git diff --no-ext-diff -- "packages/happyherd app/.mcp.json"',
        );

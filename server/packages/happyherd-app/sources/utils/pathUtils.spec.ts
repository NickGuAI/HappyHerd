...
describe('pathUtils', () => {
    ...
    describe('integration scenarios', () => {
        it('should work with typical macOS home directories', () => {
            ...
            expect(resolveAbsolutePath('~/Projects/happyherd', homeDir)).toBe('/Users/developer/Projects/happyherd');
        ...
        it('should work with typical Linux home directories', () => {
            ...
            expect(resolveAbsolutePath('~', homeDir)).toBe('/home/user');
            expect(resolveAbsolutePath('~/projects/happyherd', homeDir)).toBe('/home/user/projects/happyherd');
            expect(resolveAbsolutePath('~/documents/file.txt', homeDir)).toBe('/home/user/documents/file.txt');
        });
        ...
        it('should work with typical Windows home directories', () => {
            ...
            expect(resolveAbsolutePath('~/Projects/happyherd', homeDir)).toBe('C:\\Users\\developer\\Projects/happyherd');

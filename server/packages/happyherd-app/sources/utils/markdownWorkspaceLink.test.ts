...
describe('markdownWorkspaceLink', () => {
    ...
    it('builds typed route params without encoding special path names', () => {
        expect(buildWorkspaceLinkRoute({
            ...
            machineId: 'machine-origin',
            absolutePath: '/srv/projects/happyherd/研究/My File.ts',
            line: 8,
            column: 13,
        })).toEqual({
            pathname: '/workspace',
    ...
    it.each([
        ['relative file', 'src/../docs/readme.md', '/srv/projects/happyherd/docs/readme.md'],
        ['folder-looking target', 'docs', '/srv/projects/happyherd/docs'],
    ...
    it('resolves a sibling link from the viewed file directory without changing session provenance', () => {
        expect(resolveMarkdownWorkspaceLinkRoute({
            ...
            originSessionId: 'session-origin',
            metadata,
            relativeTo: '/srv/projects/happyherd/myboken/4. Daily/2026/09-01',
        })).toEqual({
            pathname: '/workspace',
            params: {
                mode: 'link',
                originSessionId: 'session-origin',
                machineId: 'machine-origin',
                absolutePath: '/srv/projects/happyherd/myboken/4. Daily/2026/09-01/john-mccarthy.md',
                line: '12',
            },
        });
    });
    ...
    it('resolves an inline image only inside the originating session root', () => {
        expect(resolveMarkdownWorkspaceImageReference({
            ...
            rootPath: '/srv/projects/happyherd',
            workspaceRoute: {
                pathname: '/workspace',
                params: {
                    mode: 'link',
                    originSessionId: 'session-origin',
                    machineId: 'machine-origin',
                    absolutePath: '/srv/projects/happyherd/screenshots/result.png',
                },
            },
        });
    });
    ...
    it('resolves a sibling image from the viewed file directory but retains the session-root read boundary', () => {
        expect(resolveMarkdownWorkspaceImageReference({
            ...
            originSessionId: 'session-origin',
            metadata,
            relativeTo: '/srv/projects/happyherd/docs',
        })).toEqual({
            rootPath: '/srv/projects/happyherd',
            workspaceRoute: {
                pathname: '/workspace',
                params: {
                    ...
                    originSessionId: 'session-origin',
                    machineId: 'machine-origin',
                    absolutePath: '/srv/projects/happyherd/docs/images/chart.png',
                },
            },
        });
    });

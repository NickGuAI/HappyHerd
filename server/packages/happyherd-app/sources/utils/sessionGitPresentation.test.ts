...
describe('session git presentation', () => {
    ...
    it('uses HappyHerd Agent statistics without a file cache and preserves approximation', () => {
    ...
    it('clears stale cached counts when HappyHerd Agent reports a clean workspace', () => {
        expect(resolveSessionGitPresentation({
    ...
    it('does not use HappyHerd Agent summaries for legacy sessions', () => {

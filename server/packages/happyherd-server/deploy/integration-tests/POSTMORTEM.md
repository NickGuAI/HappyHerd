...
## Setup
- 2 happyherd-server replicas behind a `LoadBalancer` service via `minikube tunnel`
...
**Observation:** `kubectl exec happyherd-redis-0 -- redis-cli XINFO STREAM socket.io`

...
Stress tests that run against a real multi-replica HappyHerd server on minikube.
...
# Access Redis CLI
kubectl exec -it happyherd-redis-0 -- redis-cli

# Access MinIO console
kubectl port-forward svc/happyherd-minio 9001:9001

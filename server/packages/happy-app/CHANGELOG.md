...
- Inspect automations in a desktop side panel or mobile full-width view with preserved search filters, collapsible Markdown instructions, and quick access to schedules, run history, and controls.

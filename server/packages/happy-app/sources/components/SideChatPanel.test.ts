...
describe('SideChatPanel', () => {
    it('creates immediately from the zero-child action without rendering a brief form', () => {
        const onCreateSideChat = vi.fn();
        ...
        expect(onCreateSideChat).toHaveBeenCalledOnce();

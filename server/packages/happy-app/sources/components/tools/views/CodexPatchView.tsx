...
function localizedPatchKind(change: CodexPatchEntry): string | null {
    switch (getPatchKindLabel(change)) {
        case 'new': return t('uiCopy.new');
        case 'delete': return t('uiCopy.deleted');
        case 'move': return t('diff.renamed');
        case 'edit': return t('toolGroup.edited');
        default: return null;
    }
}

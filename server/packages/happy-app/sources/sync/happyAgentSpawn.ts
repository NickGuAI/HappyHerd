...
export class HappyAgentWorkspaceUnavailableError extends Error {
    constructor() {
        super();
        this.name = 'HappyAgentWorkspaceUnavailableError';
        Object.setPrototypeOf(this, HappyAgentWorkspaceUnavailableError.prototype);
    }
}
...
export function resolveHappyAgentSpawnTarget(options: {
    ...
    if (!workspace) {
        throw new HappyAgentWorkspaceUnavailableError();
    }

/**
 * Environment variables that identify one particular HappyHerd or provider
 ...
 */
import { canonicalEnvironment, legacyEnvironmentKey } from '@/legacyCompatibility';

const CANONICAL_SESSION_SCOPED_ENV_KEYS = [
    'HAPPYHERD_RECONNECT_SESSION_ID',
    'HAPPYHERD_RECONNECT_ENCRYPTION_KEY',
    'HAPPYHERD_RECONNECT_ENCRYPTION_VARIANT',
    'HAPPYHERD_RECONNECT_SEQ',
    'HAPPYHERD_RECONNECT_METADATA_VERSION',
    'HAPPYHERD_RECONNECT_AGENT_STATE_VERSION',
    'HAPPYHERD_RECONNECT_QUEUE_MESSAGE_ID',
    'HAPPYHERD_FRESH_PROVIDER_RECONNECT',
    'HAPPYHERD_FORKED_FROM_SESSION_ID',
    'HAPPYHERD_FORKED_FROM_MESSAGE_ID',
    'HAPPYHERD_FORK_CLAUDE_SESSION_ID',
    'HAPPYHERD_FORK_CODEX_THREAD_ID',
    'HAPPYHERD_SIDE_CHAT',
    'HAPPYHERD_SUPER_SESSION',
...
export const SESSION_SCOPED_ENV_KEYS = [
    ...CANONICAL_SESSION_SCOPED_ENV_KEYS,
    ...CANONICAL_SESSION_SCOPED_ENV_KEYS.flatMap((key) => legacyEnvironmentKey(key) ?? []),
];
...
export function buildSessionChildEnvironment(
    ...
    return { ...ambient, ...canonicalEnvironment(explicitEnv) };
}

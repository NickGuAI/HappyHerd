...
describe('daemon spawn mode arguments', () => {
    ...
    it.each([
        ...
        'bypassPermissions',
        'plan',
    ])('forwards machine-advertised Grok launch mode %s to the HappyHerd command', (permissionMode) => {
        const args = ['grok'];
    ...
    it('forwards the target-validated dsh tuple to the HappyHerd wrapper', () => {
        const args = ['dsh'];

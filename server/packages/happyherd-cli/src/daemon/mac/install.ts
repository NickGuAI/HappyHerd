/**
 * Installation script for HappyHerd daemon using macOS LaunchDaemons
 * 
...
const PLIST_LABEL = 'com.happyherd-cli.daemon';
...
export async function install(): Promise<void> {
    try {
        ...
        const happyherdPath = process.argv[0]; // Node.js executable
        ...
        const plistContent = trimIdent(`
            ...
            <dict>
                ...
                <array>
                    <string>${happyherdPath}</string>
                    <string>${scriptPath}</string>
                    <string>happyherd-daemon</string>
                </array>
                
                <key>EnvironmentVariables</key>
                <dict>
                    <key>HAPPYHERD_DAEMON_MODE</key>
                    <string>true</string>
                </dict>
                ...
                <string>${os.homedir()}/.happyherd/daemon.err</string>
                
                <key>StandardOutPath</key>
                <string>${os.homedir()}/.happyherd/daemon.log</string>
        ...
        logger.info('Check logs at ~/.happyherd/daemon.log');

...
function visibleCodexMessageText(text: string): string | null {
    ...
    // Also strip HappyHerd's own injected scaffolding (option-chips system prompt +
    ...
    const visibleText = stripLeadingTaskNotificationWrappers(stripHappyHerdSystemBlocks(text));

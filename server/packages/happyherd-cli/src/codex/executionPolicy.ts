...
export function resolveCodexExecutionPolicy(
    ...
    _sandboxManagedByHappyHerd: boolean,
...
export function shouldAutoApproveCodexApproval(
    permissionMode: PermissionMode,
    sandboxManagedByHappyHerd: boolean,
): boolean {
    return resolveCodexApprovalDisposition(permissionMode, sandboxManagedByHappyHerd) === 'approved';
}

...
beforeAll(() => { originalRoot = process.env.HAPPYHERD_HOME_DIR; });
afterAll(() => {
  if (originalRoot === undefined) delete process.env.HAPPYHERD_HOME_DIR;
  else process.env.HAPPYHERD_HOME_DIR = originalRoot;
});

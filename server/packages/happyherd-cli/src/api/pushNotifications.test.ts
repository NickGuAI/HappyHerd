...
function makeMetadata(overrides: Partial<Metadata> = {}): Metadata {
    return {
        path: '/Users/test/projects/happyherd',
        host: 'test-host',
        homeDir: '/Users/test',
        happyHomeDir: '/Users/test/.happyherd',
        happyLibDir: '/Users/test/.happyherd/lib',
        happyToolsDir: '/Users/test/.happyherd/tools',
        ...overrides,
    };
}
...
describe('getSessionNotificationBody', () => {
    ...
    it('falls back to the last path segment', () => {
        const metadata = makeMetadata({
            path: '/Users/test/projects/happyherd-cli',
        });

        expect(getSessionNotificationBody(metadata)).toBe('happyherd-cli');
    });

 ...
 * the HappyHerd CLI and mobile app.
 * 
 ...
 * These messages are forwarded to the HappyHerd server and mobile app.
 */
...
/** Agent identifier */
export type AgentId = 'claude' | 'codex' | 'gemini' | 'opencode' | 'agy' | 'claude-acp' | 'codex-acp';
 ...
 * this interface to be usable through the HappyHerd CLI and mobile app.
 */

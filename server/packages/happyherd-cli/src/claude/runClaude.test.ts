...
vi.mock('@/claude/utils/startHappyHerdServer', () => ({
    startHappyHerdServer: mockStartHappyHerdServer,
}));
...
vi.mock('@/claude/utils/generateHookSettings', () => ({
    generateHookSettingsFile: vi.fn(() => '/tmp/happyherd-hook-settings.json'),
...
describe('runClaude remote JSONL scanner', () => {
    ...
    beforeEach(() => {
        ...
        delete process.env.HAPPYHERD_RECONNECT_SEQ;
        delete process.env.HAPPYHERD_RECONNECT_METADATA_VERSION;
        delete process.env.HAPPYHERD_RECONNECT_AGENT_STATE_VERSION;
        delete process.env.HAPPYHERD_RECONNECT_QUEUE_MESSAGE_ID;
        delete process.env.HAPPYHERD_FORKED_FROM_SESSION_ID;
        delete process.env.HAPPYHERD_FORKED_FROM_MESSAGE_ID;
        delete process.env.HAPPYHERD_FORK_CLAUDE_SESSION_ID;
        ...
        mockStartHappyHerdServer.mockResolvedValue({

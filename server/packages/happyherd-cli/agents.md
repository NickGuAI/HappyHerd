...
- `packages/happyherd-cli/src/codex/codex.integration.test.ts`
- `packages/happyherd-cli/src/claude/claude.integration.test.ts`
- `packages/happyherd-cli/src/gemini/gemini.integration.test.ts`

...
export type HappyHerdControlClientOptions = {
    config: Config;
...
export class HappyHerdControlClient {
    readonly config: Config;
    readonly credentials: Credentials;

    constructor(options: HappyHerdControlClientOptions) {
        this.config = options.config;
        this.credentials = options.credentials;
    }

    static fromEnvironment(): HappyHerdControlClient {
        const config = loadConfig();
        return new HappyHerdControlClient({
            config,
